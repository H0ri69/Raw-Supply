...
const About: React.FC = () => {
  return (
    <PageTransition>
      <div className="pt-20 min-h-screen bg-[#F9F9F9] dark:bg-[#111111]">
        {/* Header */}
        <div className="px-6 py-20 bg-white dark:bg-black border-b border-gray-100 dark:border-gray-900">
          <div className="max-w-5xl mx-auto text-center">
            <Reveal width="100%">
              <h1 className="text-5xl md:text-8xl font-black uppercase tracking-tighter mb-8 leading-[0.85] text-black dark:text-white">
                Fashion Is<br />A Battle
              </h1>
            </Reveal>
            <Reveal width="100%" delay={0.2}>
              <p className="text-xl md:text-2xl font-mono text-gray-500 dark:text-gray-400 max-w-2xl mx-auto tracking-tight uppercase">
        ...
        <div className="flex flex-col md:flex-row min-h-[80vh]">
          ...
          <div className="w-full md:w-1/2 bg-black dark:bg-white relative overflow-hidden group">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 border-t border-gray-200 dark:border-gray-800">
          <div className="p-12 border-b md:border-b-0 md:border-r border-gray-200 dark:border-gray-800 hover:bg-black dark:hover:bg-white hover:text-white dark:hover:text-black text-black dark:text-white transition-colors duration-500 group bg-white dark:bg-black h-full flex flex-col justify-between">
          ...
          <div className="p-12 hover:bg-black dark:hover:bg-white hover:text-white dark:hover:text-black text-black dark:text-white transition-colors duration-500 group bg-white dark:bg-black h-full flex flex-col justify-between">
