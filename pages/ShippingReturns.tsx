...
const ShippingReturns: React.FC = () => {
    return (
        <div className="pt-32 pb-20 px-6 lg:px-12 max-w-4xl mx-auto">
            <h1 className="text-4xl lg:text-6xl font-black uppercase tracking-tighter mb-12">Shipping & Returns</h1>

            <div className="space-y-12 font-mono text-sm leading-relaxed text-gray-600">
                <section>
                    <h2 className="text-black font-bold uppercase tracking-widest mb-4">01. Shipping Policy</h2>
                    <p className="mb-4">
                ...
                <section>
                    <h2 className="text-black font-bold uppercase tracking-widest mb-4">02. International Shipping</h2>
                    <p>
                ...
                <section>
                    <h2 className="text-black font-bold uppercase tracking-widest mb-4">03. Returns</h2>
                    <p className="mb-4">
                ...
                <section>
                    <h2 className="text-black font-bold uppercase tracking-widest mb-4">04. Refunds</h2>
                    <p>
