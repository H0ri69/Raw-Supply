...
const TermsOfService: React.FC = () => {
    return (
        <div className="pt-32 pb-20 px-6 lg:px-12 max-w-4xl mx-auto">
            <h1 className="text-4xl lg:text-6xl font-black uppercase tracking-tighter mb-12 text-black dark:text-white">Terms of Service</h1>

            <div className="space-y-12 font-mono text-sm leading-relaxed text-gray-600 dark:text-gray-400">
                <section>
                    <h2 className="text-black dark:text-white font-bold uppercase tracking-widest mb-4">01. Agreement to Terms</h2>
                    <p>
                ...
                <section>
                    <h2 className="text-black dark:text-white font-bold uppercase tracking-widest mb-4">02. Intellectual Property Rights</h2>
                    <p>
                ...
                <section>
                    <h2 className="text-black dark:text-white font-bold uppercase tracking-widest mb-4">03. User Representations</h2>
                    <p>
                ...
                <section>
                    <h2 className="text-black dark:text-white font-bold uppercase tracking-widest mb-4">04. Products</h2>
                    <p>
